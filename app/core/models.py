...
class EvalItem:
    ...
    actual_output: str
    expected_output: Optional[str] = None
    context: list[str] = field(default_factory=list)  # retrieved chunks, for RAG scorers
    variant: Optional[str] = None  # tags which model/prompt produced this output, for comparison
    metadata: dict[str, Any] = field(default_factory=dict)
